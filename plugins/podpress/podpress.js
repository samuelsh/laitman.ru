	...
	function podPressGenerateVideoPreview (strPlayerDiv, strMediaFile, numWidth, numHeight, strPreviewImg, bPreviewOnly) {
		...
		if(numHeight < 80) {
			...
			strPreviewImg = podPressBackendURL+'images/loading.gif';
		}
...
//				strResult += '</object><br/><br/>';
			...
			//case 'asf': //BB Dev
			case 'wmv':
				strResult = '<object id="winplayer" style="display:block;" classid="clsid:6BF52A52-394A-11d3-B153-00C04F79FAA6" width="'+numWidth+'" height="'+numHeight+'" standby="Media is loading..." type="application/x-oleobject">';
			...
			case 'asf':
				...
				strResult += '	<param name="ShowDisplay" value="false" />';
				strResult += '	<param name="ShowStatusBar" value="false" />';
				strResult += '	<param name="uiMode" value="full" />';
