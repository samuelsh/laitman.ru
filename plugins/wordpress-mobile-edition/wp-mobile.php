...
function cfmobi_mobile_exit() {
	echo '<p><a href="'.trailingslashit(get_bloginfo('home')).'?cf_action=reject_mobile">Выйти из текстовой версии</a> <span class="small">(стандартная браузерная версия)</span>.</p>';
}

function cfmobi_mobile_available($content) {
	if (!defined('WPCACHEHOME')) {
		$content = $content.'<p><a href="'.trailingslashit(get_bloginfo('home')).'?cf_action=show_mobile">Вернуться в текстовую версию</a>.</p>';
	}
	return $content;
}
