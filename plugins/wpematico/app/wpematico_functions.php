...
function bb_parse_content( $content ) {
	...
	foreach ($lessons as $lesson){
		...
		$content .= '<tbody>';
		$content .= '<tr>';
		$content .= '<td><span class="podPress_content"><img src="https://www.laitman.ru/wp-content/plugins/podpress/images/video_mp4_icon.png" 
		...
		$content .= '</td>';
		$content .= '<td>&nbsp;</td>';
		$content .= '<td><span class="podPress_content"><img src="https://www.laitman.ru/wp-content/plugins/podpress/images/audio_mp3_icon.png" 
