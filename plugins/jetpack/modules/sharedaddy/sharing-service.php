...
function sharing_display( $text = '', $echo = false ) {
	...
	if ( $show ) {
		...
		if ( count( $enabled['all'] ) > 0 ) {
			...
			// Wrapper
			$sharing_content .= '<div class="sharedaddy sd-sharing-enabled"><div class="robots-nocontent sd-block sd-social sd-social-' . $global['button_style'] . ' sd-sharing" style="margin-bottom:-25px">';
