...
class nggGallery {
	...
	**/
	 ...
	 */
	public static function get_theme_css_file() {
     ...
     */
    public static function detect_mobile_phone() {
        ...
        $useragents = apply_filters( 'wptouch_user_agents', $useragents );
 		...
 		foreach ( $useragents as $useragent ) {
			if ( isset($_SERVER['HTTP_USER_AGENT']) && preg_match( "#$useragent#i", $_SERVER['HTTP_USER_AGENT'] ) )
				return true;
		}
