...
add_option('feedburner_settings',$data,'');
...
function ol_feed_redirect() {
	...
	&& (isset($wp->query_vars['category_name']) && $wp->query_vars['category_name'] == '') && 
	($withcomments != 1) && trim($feedburner_settings['feedburner_url']) != '') {
